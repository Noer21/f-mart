...
export class MyApp {
  ...
  rootPage: any = LaporanPenjualanPage;
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Inventaris', component: InventarisPage },
      { title: 'Daftar Supplier', component: DaftarSupplierPage },
      { title: 'Laporan Penjualan', component: LaporanPenjualanPage }
